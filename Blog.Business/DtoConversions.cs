...
namespace Blog.Business
{
    public static class DtoConversions
    {
        ...
        {
            return u != null ? new UserDto { City = u.City, Email = u.Email, Id = u.Id, Name = u.Name, Password = u.Password, Phone = u.Phone, Role = u.Role } : null;
        }
        ...
        {
            return new User { City = u.City, Email = u.Email, Id = u.Id, Name = u.Name, Password = u.Password, Phone = u.Phone, Role = u.Role };
